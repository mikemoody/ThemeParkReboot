<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ThemePark.Contact" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <hgroup class="title">
        ...
        <h2>
            <br />
            <asp:Label runat="server" ID="HeaderDisplay">

            </asp:Label>
            <br />
            <br />
               <asp:Label runat="server" ID="HeaderDisplay2">
...
<body>
  <h2>
      <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="ContactIndia.aspx"> I am from India, Change Globalization Here!</asp:HyperLink>
